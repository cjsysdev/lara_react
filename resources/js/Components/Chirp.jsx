...
export default function Chirp({ chirp }) {
    ...
    return (
        <div className="p-6 flex space-x-2 dark:bg-gray-800 border-gray-900">
            <svg
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    <div>
                        <span className="text-gray-100">{chirp.user.name}</span>
                ...
                {editing ? (
                    <form onSubmit={submit}>
                        <textarea
                            ...
                            className="mt-4 w-full dark:bg-gray-800 text-gray-100 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200
